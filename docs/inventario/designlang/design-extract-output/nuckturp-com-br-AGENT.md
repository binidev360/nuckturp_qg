# You are building UI in the nuckturp.com.br design system.
...
- secondary   #c08aff
- accent      #77b30f
- neutrals    #383838 · #f7ffe6 · #8c8c8c · #000000 · #1f1f1f · #0f0f0f

## Typography

- families   Inter · Space Grotesk
- weights    400 · 600 · 500 · 700 · 900
- base size  16px
...
- headings   Title Case
- CTA verbs  comece · para · lovecraft · entrar · criar · veja

## Component anatomy

- card       variants: [object Object] · [object Object]  ·  slots: false · true · true · false
...
```bash
npx designlang nuckturp.com.br
```
...
Generated by designlang. Re-extract by running `npx designlang nuckturp.com.br`.
